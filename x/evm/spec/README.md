...
The `x/evm` is part of the [ethermint library](https://pkg.go.dev/github.com/Ambiplatforms-TORQUE/ethermint). For an example of how Ethermint can be used on any Cosmos-SDK chain, please refer to [Arcis](https://www.github.com/Ambiplatforms-TORQUE/arcis).
