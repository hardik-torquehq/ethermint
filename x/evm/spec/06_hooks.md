...
## Use Case: Call Native ERC20 Module on Arcis

Here is an example taken from the Arcis [erc20 module](https://arcis.dev/modules/erc20/) that shows how the `EVMHooks` supports a contract calling a native module to convert ERC-20 Tokens into Cosmos native Coins. Following the steps from above.
